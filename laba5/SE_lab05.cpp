...
void main() {
	...
	try {
		...
		Instance test1 = Create("ZZZZZZZZZ", 5);
#endif
		...
		dictionary::Entry e1 = { 1,"Белодед" }, e2 = { 2,"Наркевич" },
			e3 = { 3,"Калиновская" }, e4 = { 4,"Доморад" }, e5 = { 5,"Барковский" };
