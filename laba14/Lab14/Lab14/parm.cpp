...
namespace Parm
{
    ...
    PARM getparm(int argc, _TCHAR* argv[])
    {
        ...
        {
            if (wcsstr(argv[i], PARM_IN))//ищет подстроку PARM_IN в текущем аргументе командной строки 
                hasIn = true;
        ...
        // ≈сли параметр -out отсутствует, то значение parm.out устанавливаетс€ равным parm.in, а затем добавл€етс€ расширение по умолчанию PARM_OUT_DEFAULT_EXT.
        if (!hasOut)
        {
