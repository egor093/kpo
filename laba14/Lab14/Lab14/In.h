...
//Таблица для классификации символов
...
namespace In
{
    ...
    struct IN
    {
        enum { T = 1024, F = 2048, I = 4096, S = 8192, O = 16384 }; // Типы символов, Т- допустимый символ, F - недопустимый,I - игнорировать,иначе заметить 
